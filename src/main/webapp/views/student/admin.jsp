    ...
    <div class="row row-offcanvas row-offcanvas-left">
        <div class="col-md-3 col-lg-2 sidebar-offcanvas" id="sidebar" role="navigation">
            <ul class="nav flex-column pl-1">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="#submenu1" data-toggle="collapse" data-target="#submenu1">Actions ▾</a>
                    <ul class="list-unstyled flex-column pl-3 collapse" id="submenu1" aria-expanded="false">
                        <li class="nav-item"><a class="nav-link" href="addBook">Add Book</a></li>
                        <li class="nav-item"><a class="nav-link" href="libBooks">List of Books</a></li>
                        <li class="nav-item"><a class="nav-link" href="api/issues/list">Issue History</a></li>
                    </ul>
                </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#submenu2" data-toggle="collapse" data-target="#submenu1">Export ▾</a>
                        <ul class="list-unstyled flex-column pl-3 collapse" id="submenu2" aria-expanded="false">
                            <li class="nav-item"><a class="nav-link" href="">Csv</a></li>
                            <li class="nav-item"><a class="nav-link" href="">Pdf</a></li>
                            <li class="nav-item"><a class="nav-link" href="">Excel</a></li>
                        </ul>
                    </li>
                <%--<li class="nav-item"><a class="nav-link" href="#">AddBook</a></li>--%>
        ...
        <div class="col-md-9 col-lg-10 main">
            ...
            <div style="text-align: center">
                Welcome your registration number id is: <%=session.getAttribute("userId") %>, You logged in as:<%=session.getAttribute("userType") %>
                <br>
            </div>
